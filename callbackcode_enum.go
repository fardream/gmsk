...
const (
	...
	CALLBACK_BEGIN_FOLDING               CallbackCode = C.MSK_CALLBACK_BEGIN_FOLDING               // The calback function is called at the beginning of folding.
	CALLBACK_BEGIN_FOLDING_BI            CallbackCode = C.MSK_CALLBACK_BEGIN_FOLDING_BI            // TBD
	CALLBACK_BEGIN_FOLDING_BI_DUAL       CallbackCode = C.MSK_CALLBACK_BEGIN_FOLDING_BI_DUAL       // TBD
	CALLBACK_BEGIN_FOLDING_BI_INITIALIZE CallbackCode = C.MSK_CALLBACK_BEGIN_FOLDING_BI_INITIALIZE // TBD
	CALLBACK_BEGIN_FOLDING_BI_OPTIMIZER  CallbackCode = C.MSK_CALLBACK_BEGIN_FOLDING_BI_OPTIMIZER  // TBD
	CALLBACK_BEGIN_FOLDING_BI_PRIMAL     CallbackCode = C.MSK_CALLBACK_BEGIN_FOLDING_BI_PRIMAL     // TBD
	...
	CALLBACK_BEGIN_INITIALIZE_BI         CallbackCode = C.MSK_CALLBACK_BEGIN_INITIALIZE_BI         // The callback function is called from within the basis identification procedure when the initialization phase is started.
	...
	CALLBACK_BEGIN_OPTIMIZE_BI           CallbackCode = C.MSK_CALLBACK_BEGIN_OPTIMIZE_BI           // TBD.
	...
	CALLBACK_DECOMP_MIO                  CallbackCode = C.MSK_CALLBACK_DECOMP_MIO                  // The callback function is called when the dedicated algorithm for independent blocks inside the mixed-integer solver is started.
	...
	CALLBACK_END_FOLDING                 CallbackCode = C.MSK_CALLBACK_END_FOLDING                 // The calback function is called at the end of folding.
	CALLBACK_END_FOLDING_BI              CallbackCode = C.MSK_CALLBACK_END_FOLDING_BI              // TBD
	CALLBACK_END_FOLDING_BI_DUAL         CallbackCode = C.MSK_CALLBACK_END_FOLDING_BI_DUAL         // TBD
	CALLBACK_END_FOLDING_BI_INITIALIZE   CallbackCode = C.MSK_CALLBACK_END_FOLDING_BI_INITIALIZE   // TBD
	CALLBACK_END_FOLDING_BI_OPTIMIZER    CallbackCode = C.MSK_CALLBACK_END_FOLDING_BI_OPTIMIZER    // TBD
	CALLBACK_END_FOLDING_BI_PRIMAL       CallbackCode = C.MSK_CALLBACK_END_FOLDING_BI_PRIMAL       // TBD
	...
	CALLBACK_END_INITIALIZE_BI           CallbackCode = C.MSK_CALLBACK_END_INITIALIZE_BI           // The callback function is called from within the basis identification procedure when the initialization phase is terminated.
	...
	CALLBACK_END_OPTIMIZE_BI             CallbackCode = C.MSK_CALLBACK_END_OPTIMIZE_BI             // TBD.
	...
	CALLBACK_FOLDING_BI_DUAL             CallbackCode = C.MSK_CALLBACK_FOLDING_BI_DUAL             // TBD
	CALLBACK_FOLDING_BI_OPTIMIZER        CallbackCode = C.MSK_CALLBACK_FOLDING_BI_OPTIMIZER        // TBD
	CALLBACK_FOLDING_BI_PRIMAL           CallbackCode = C.MSK_CALLBACK_FOLDING_BI_PRIMAL           // TBD
	CALLBACK_HEARTBEAT                   CallbackCode = C.MSK_CALLBACK_HEARTBEAT                   // A heartbeat callback.
	...
	CALLBACK_OPTIMIZE_BI                 CallbackCode = C.MSK_CALLBACK_OPTIMIZE_BI                 // TBD.
	...
	CALLBACK_QO_REFORMULATE              CallbackCode = C.MSK_CALLBACK_QO_REFORMULATE              // The callback function is called at an intermediate stage of the conic quadratic reformulation.
...
var _CallbackCode_map = map[CallbackCode]string{
	...
	CALLBACK_BEGIN_FOLDING:               "CALLBACK_BEGIN_FOLDING",
	CALLBACK_BEGIN_FOLDING_BI:            "CALLBACK_BEGIN_FOLDING_BI",
	CALLBACK_BEGIN_FOLDING_BI_DUAL:       "CALLBACK_BEGIN_FOLDING_BI_DUAL",
	CALLBACK_BEGIN_FOLDING_BI_INITIALIZE: "CALLBACK_BEGIN_FOLDING_BI_INITIALIZE",
	CALLBACK_BEGIN_FOLDING_BI_OPTIMIZER:  "CALLBACK_BEGIN_FOLDING_BI_OPTIMIZER",
	CALLBACK_BEGIN_FOLDING_BI_PRIMAL:     "CALLBACK_BEGIN_FOLDING_BI_PRIMAL",
	CALLBACK_BEGIN_INFEAS_ANA:            "CALLBACK_BEGIN_INFEAS_ANA",
	CALLBACK_BEGIN_INITIALIZE_BI:         "CALLBACK_BEGIN_INITIALIZE_BI",
	...
	CALLBACK_BEGIN_OPTIMIZE_BI:           "CALLBACK_BEGIN_OPTIMIZE_BI",
	...
	CALLBACK_DECOMP_MIO:                  "CALLBACK_DECOMP_MIO",
	...
	CALLBACK_END_FOLDING:                 "CALLBACK_END_FOLDING",
	CALLBACK_END_FOLDING_BI:              "CALLBACK_END_FOLDING_BI",
	CALLBACK_END_FOLDING_BI_DUAL:         "CALLBACK_END_FOLDING_BI_DUAL",
	CALLBACK_END_FOLDING_BI_INITIALIZE:   "CALLBACK_END_FOLDING_BI_INITIALIZE",
	CALLBACK_END_FOLDING_BI_OPTIMIZER:    "CALLBACK_END_FOLDING_BI_OPTIMIZER",
	CALLBACK_END_FOLDING_BI_PRIMAL:       "CALLBACK_END_FOLDING_BI_PRIMAL",
	CALLBACK_END_INFEAS_ANA:              "CALLBACK_END_INFEAS_ANA",
	CALLBACK_END_INITIALIZE_BI:           "CALLBACK_END_INITIALIZE_BI",
	...
	CALLBACK_END_OPTIMIZE_BI:             "CALLBACK_END_OPTIMIZE_BI",
	...
	CALLBACK_FOLDING_BI_DUAL:             "CALLBACK_FOLDING_BI_DUAL",
	CALLBACK_FOLDING_BI_OPTIMIZER:        "CALLBACK_FOLDING_BI_OPTIMIZER",
	CALLBACK_FOLDING_BI_PRIMAL:           "CALLBACK_FOLDING_BI_PRIMAL",
	...
	CALLBACK_OPTIMIZE_BI:                 "CALLBACK_OPTIMIZE_BI",
	CALLBACK_PRIMAL_SIMPLEX:              "CALLBACK_PRIMAL_SIMPLEX",
	CALLBACK_QO_REFORMULATE:              "CALLBACK_QO_REFORMULATE",
